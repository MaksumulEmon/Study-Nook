  ...
  return (
    <footer className="bg-slate-950 text-slate-400 font-sans border-t border-slate-900/60 selection:bg-[#9d4edd]/20 selection:text-white">
      <div className="px-8 md:px-16 lg:px-24 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 lg:gap-16 pb-16">
          ...
          <div className="flex flex-col gap-5  lg:text-center">
            ...
            {/* Add "items-center" to the nav container */}
            <nav className="flex flex-col lg:items-center gap-3.5 text-[13.5px] font-medium">
          ...
          <div className="flex flex-col gap-5">
            <h3 className="text-xs font-semibold text-slate-200 uppercase tracking-widest">Solutions</h3>
            <nav className="flex flex-col gap-3.5 text-[13.5px] font-medium">
              <Link href="/solutions/libraries" className="text-slate-400 hover:text-white transition-colors duration-200 w-fit">
                For Libraries
              </Link>
              <Link href="/solutions/campuses" className="text-slate-400 hover:text-white transition-colors duration-200 w-fit">
                For Campuses
              </Link>
              <Link href="/solutions/students" className="text-slate-400 hover:text-white transition-colors duration-200 w-fit">
                For Students
              </Link>
            </nav>
          </div>
